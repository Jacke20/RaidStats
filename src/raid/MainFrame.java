...
public class MainFrame {
	...
	public static void main(String[] args) {
		...
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(
				MainFrame.class.getResource("wow.png")));
		...
		rFileButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					tr.search(characters, groupPanel, itemLevel, groupWindow,
							listPanel, charWindow, frame);
		...
		addCharacterButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JSONObject obj = characterPanel.getURL(textFieldCharacter
						.getText(), realms.getSelectedItem().toString());
				...
				if (!textFieldCharacter.getText().equals("")
						&& obj != null
						&& !characters.containsKey(textFieldCharacter.getText()
								.toLowerCase())) {

					// Add the character name to an arraylist to keep track of
					// duplicates
					...
					itemLevel.put(nameDummy, characterPanel.itemLevelValue()); // Add
																				// player
																				// and
																				// the
																				// corresponding
					...
					JOptionPane.showMessageDialog(null,
							"Player successfully added!", "Success!",
